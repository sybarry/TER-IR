...
public abstract class AConnectionCommunication implements IConnectionCommunication{
	...
	//protected permet de ne pas etre visible par l'utilisateur mais d'etre visible par ces sous-classes
	protected void ACK(IMessage<?> msg, int timeOut) throws IOException {
	...
	protected void initialisationInfoMessage(IMessage<?> msg, boolean withACK) {
	...
	protected void AsendMessage(IMessage<?> msg) throws IOException, MessageException{
	...
	protected IMessage<?> AreceiveMessage() throws IOException, MessageException{
		if(dIn != null) {
	...
	protected void AsendMessageSynchronized(IMessage<?> msg) throws IOException, MessageException{
	...
	protected void AsendMessageAsynchronized(final IMessage<?> msg) throws IOException, MessageException {
		initialisationInfoMessage(msg, true);
