...
/**
 * Classe permettant de piloter le robot en fonction de la couleur détectée par le capteur de couleur sur le sol.
 */
public class ConduiteByColor {
    ...
    /**
	 * Initialiser les moteurs, le capteur de couleur et le capteur ultrasonique. <br>
     * Le moteur gauche est connecté au port B et le moteur droit est connecté au port C. <br>
	 */
    ...
    /**
	 * Méthode principale pour piloter le robot en fonction de la couleur détectée par le capteur de couleur.
     * @throws InterruptedException si le thread est interrompu.
     * @throws RuntimeException si le programme est arrêté par l'utilisateur.
	 */
    public void test_avec_couleur() throws InterruptedException, RuntimeException {
        ...
        while (true) {
            ...
            } else contourObstacle();
        }
    }

    /**
     * Méthode pour détecter un obstacle à l'aide du capteur ultrasonique. (Distance > 0.15 m)
    ...
    /**
     * Méthode pour contourner un obstacle.
     */
